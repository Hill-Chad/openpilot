...
class CAR:
  ...
  COROLLAH_TSS2 = "TOYOTA COROLLA LE HYBRID 2020"
...
FINGERPRINTS = {
  ...
  #replaced camryh fingerprint for highlander to avoid false fingerprint
  CAR.CAMRYH: [{
...
NO_DSU_CAR = [CAR.CHR, CAR.CHRH, CAR.CAMRY, CAR.CAMRYH, CAR.RAV4_TSS2, CAR.COROLLA_TSS2, CAR.LEXUS_ESH_TSS2, CAR.COROLLAH_TSS2]
TSS2_CAR = [CAR.RAV4_TSS2, CAR.COROLLA_TSS2, CAR.LEXUS_ESH_TSS2, CAR.COROLLAH_TSS2]
NO_STOP_TIMER_CAR = [CAR.RAV4H, CAR.HIGHLANDERH, CAR.HIGHLANDER, CAR.RAV4_TSS2, CAR.COROLLA_TSS2, CAR.LEXUS_ESH_TSS2, CAR.SIENNA, CAR.COROLLAH_TSS2]  # no resume button press required
